...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.spatial.preproc.channel.vols = {'E:\PET-M\ASL_dataset\example_dataset\dicom_t1mprage\nii\sAnonymous-0016-00001-000176-01.nii,1'};
...
matlabbatch{1}.spm.spatial.preproc.tissue(2).ngaus = 3;
